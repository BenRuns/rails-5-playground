...
class RingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ring" do
    assert_difference('Ring.count') do
      post rings_url, params: { ring: { description: @ring.description, image: @ring.image, name: @ring.name, name: @ring.name, style: @ring.style } }
    end
  ...
  test "should update ring" do
    patch ring_url(@ring), params: { ring: { description: @ring.description, image: @ring.image, name: @ring.name, name: @ring.name, style: @ring.style } }
